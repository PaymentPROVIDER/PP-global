...
// DLA GITHUB PAGES (basePath/assetPrefix)
const BASE = process.env.NEXT_PUBLIC_BASE_PATH || "";

/** GŁÓWNY KOMPONENT STRONY */
export default function PaymentProviderSite() {
  /** Dane przykładowych produktów (sklep) */
  const products = [
    {
      id: 1,
      name: "Produkt A",
  ...
  /** Wspierane metody płatności (sekcja Oferta) */
  const payments = [
    "Visa",
    "Mastercard",
    "American Express",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-white to-slate-50 text-slate-900">
      {/* -------------------- [1] TOP BAR -------------------- */}
      <div className="w-full text-center text-xs py-2 border-b bg-slate-50">
      ...
      {/* ------------- [3] HERO + LEAD (2 KOLUMNY) ------------- */}
      <section className="py-14" id="o-nas">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-10 items-center">
          {/* Lewa kolumna: nagłówek, opis, CTA, features */}
          <div>
            <motion.h1
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              <a
                href="#sklep"
                className="inline-flex items-center justify-center rounded-2xl px-6 py-3 border text-sm font-medium hover:shadow-md"
              >
          ...
          {/* Prawa kolumna: obraz hero (z local /public) */}
          <motion.div
          ...
          >
            <Image
              src={`${BASE}/hero.jpg`} // Używamy BASE, działa na GitHub Pages
              alt="Hero"
              width={1600}
              height={1000}
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {payments.map((name, i) => (
              <div
                key={i}
                className="rounded-xl border bg-slate-50 py-3 text-center text-sm"
              >
                {name}
              </div>
            ))}
        ...
        <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            >
              ...
              />
              <button className="rounded-2xl bg-blue-600 text-white px-5 py-3 text-sm hover:opacity-90">
                Wyślij
              </button>
            </form>
          </div>
