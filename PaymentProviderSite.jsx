      ...
      <section className="py-14 bg-white" id="kontakt">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-8">
          ...
          <div className="rounded-2xl border p-6 bg-slate-50">
            ...
            <div className="mt-2 text-sm text-slate-700">PaymentProviderGlobal.com</div>
            <div className="text-sm text-slate-700">NIP 000-000-00-00 • ul. Przykładowa 1, 00-000 Miasto</div>
            <div className="text-sm text-slate-700">Pon–Pt 9:00–17:00 • +48 123 456 789</div>
          </div>
        </div>
      </section>
